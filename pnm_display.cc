...
int pnm_end_frame(void){
    ...
    int totalColors =3;
    string fileName;
    fileName = disp_name + std::to_string(frameNumber) + ".ppm";
...
//                    x*totalColors + totalColors) = 1.0;
    ...
    {
        for(int x = 0; x < disp_xSize; x++)
        {
            std::cout<<*(Image+y*disp_xSize*totalColors + x*totalColors);
            outStream.put(*(Image+y*disp_xSize*totalColors + x*totalColors)); // Red
            outStream.put(*(Image+ y*disp_xSize*totalColors + x*totalColors + 1)); // Green
            outStream.put(*(Image+ y*disp_xSize*totalColors + x*totalColors + 2)); // Blue
        }
    }
